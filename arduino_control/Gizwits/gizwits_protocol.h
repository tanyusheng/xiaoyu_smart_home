...
* @{
*/
#define PRODUCT_KEY "f3099ecde8eb4a27a2c64ad2d55415c2"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "b343c642df8a416286dda206c812a296"
...
#define chuang_LEN                           1
#define reshiuqi_BYTEOFFSET                    0
#define reshiuqi_BITOFFSET                     2
#define reshiuqi_LEN                           1
#define jinhuaqi_BYTEOFFSET                    0
#define jinhuaqi_BITOFFSET                     3
#define jinhuaqi_LEN                           1
#define song_BYTEOFFSET                    0
#define song_BITOFFSET                     4
#define song_LEN                           1
...
typedef struct {
  ...
  uint8_t flagreshiuqi:1;
  uint8_t flagjinhuaqi:1;
  uint8_t flagsong:1;
